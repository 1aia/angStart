...
(function (jsGrid, $, undefined) {
    ...
    function ActionField(config) {
        Field.call(this, config);
        this._configInitialized = false;
    }

    ActionField.prototype = new Field({
        css: "jsgrid-control-field",
        align: "center",
        width: 50,
        filtering: false,
        ...
        itemTemplate: function (value, item) {
            ...
            $result = $result.add(this._createActionButton(item));

            return $result;
        },

        _handler: function (item, grid, e, column) {
            column.action(item, grid, e);
            e.stopPropagation();
        },
        ...
        _createActionButton: function (item) {
            return this._createGridButton(this.buttonClass, this.buttonTooltip, this._handler, item);
        },
        
        _createGridButton: function (cls, tooltip, clickHandler, item) {
            var grid = this._grid;
            var me = this;
    ...
    jsGrid.fields.action = jsGrid.ActionField = ActionField;
